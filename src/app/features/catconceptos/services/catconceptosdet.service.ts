...
export class CatConceptosDetService {
    ...
    constructor() {
        console.log('🏗️ CatConceptosDetService inicializado con cache');
    ...
    /**
     * MÉTODO UNIFICADO DE CONSULTA - Único método para todas las consultas (con cache)
     * El backend filtra inteligentemente según los parámetros enviados
     */
    queryDetalles(params: CatConceptoDetQueryParams = {}, forceRefresh: boolean = false): Observable<CatConceptoDetResponse> {
        console.log('🔍 === CONSULTA UNIFICADA CATCONCEPTOSDET ===');
        console.log('🔍 Parámetros de consulta:', params);

        // Crear clave única para el cache basada en los parámetros
        const cacheKey = this.createCacheKey('queryDetalles', params);
        ...
        const cachedData = this.getFromCache<CatConceptoDetResponse>(cacheKey);
            ...
            switchMap(url => {
                ...
                return this.http.post<CatConceptoDetRawArrayResponse>(url, payload).pipe(
                    ...
                    tap(() => {
                        ...
                        console.log('🧹 Limpiando cache después de crear detalle');
                        this.clearCache();
                    }),
                    catchError(error => {
            ...
            switchMap(url => {
                ...
                return this.http.post<CatConceptoDetRawArrayResponse>(url, payload).pipe(
                    ...
                    tap(() => {
                        ...
                        console.log('🧹 Limpiando cache después de actualizar detalle');
                        this.clearCache();
                    }),
                    catchError(error => {
            ...
            switchMap(url => {
                ...
                return this.http.post<CatConceptoDetRawArrayResponse>(url, payload).pipe(
                    ...
                    tap(() => {
                        ...
                        console.log('🧹 Limpiando cache después de eliminar detalle');
                        this.clearCache();
                    }),
                    catchError(error => {
