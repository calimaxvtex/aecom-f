...
@Component({
    ...
    template: `
        <!-- Header -->
        <div class="mb-4">
            <h2 class="text-2xl font-bold mb-2">🏷️ Gestión de Conceptos</h2>
            <p class="text-gray-600">Administra los catálogos maestros de conceptos</p>
        </div>
        ...
        <p-table
            ...
            [(selection)]="conceptoSeleccionado"
            (onRowSelect)="onConceptoSelect($event)"
            dataKey="id_c"
            [sortMode]="'multiple'"
            [filterDelay]="300"
        >
            ...
            <div class="flex items-center gap-4 mb-4">
                ...
                <div>
                    ...
                    <p class="text-gray-700 text-lg">
                        ...
                        <strong>"{{conceptoToDelete?.nombre}}"</strong>?
                    </p>
...
export class CatconceptosTabComponent implements OnInit {
    // Datos
        ...
        this.catConceptosService.getAllConceptos().subscribe({
            ...
            error: (error) => {
                ...
                this.messageService.add({
                    severity: 'error',
                    summary: 'Error',
                    detail: 'Error al cargar los conceptos',
                    life: 5000
                });
            }
        });
            ...
            this.catConceptosService.deleteConcepto(this.conceptoToDelete.id_c).subscribe({
                ...
                error: (error) => {
                    ...
                    this.messageService.add({
                        severity: 'error',
                        summary: 'Error',
                        detail: 'Error al eliminar el concepto',
                        life: 5000
                    });
    ...
    onConceptoSelect(event: any): void {
        console.log('📋 Concepto seleccionado:', event.data);
        this.conceptoSeleccionado = event.data;
    }
